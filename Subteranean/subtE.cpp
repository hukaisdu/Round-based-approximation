// ConsoleApplication_Kaola.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
#include<iostream>
#include<cstdlib>
#include<cmath>
...
void HD_L_2n( int ROUND, vector<unsigned int> diff, vector<unsigned int> diff_1, int location) {//compute the correlation for given diff and all-one-bit mask
    ...
    //  cout << "Correlation after mindle part  " << " = 2 ^ ";
    //  cout << (log2(abs(counter)) - log2(TEST_NUM + 1)) << " ";
    cout << double(counter) / double(TEST_NUM) << " " << endl;
